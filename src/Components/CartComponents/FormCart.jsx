    ...
    <Form onSubmit={formik.handleSubmit} className="fieldset">
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <Form.Text className="text-danger ">
            {formik.touched.address2 && formik.errors.address2 ? <div className="text-danger">* {formik.errors.address2}</div> : null}
          </Form.Text>
        </div>
      </div>
      ...
      <Modal dir="rtl" show={showOrderModal} onHide={() => setShowOrderModal(false)} centered>
        ...
        <Modal.Body>
          ...
          <strong>المجموع النهائي = {cart.cartTotalAmount + + cart.cartShipping}₪  </strong>
          <hr></hr>
